...
export default function BirthdayVisibilityScreen() {
  ...
  const selectedScope = privacySettings?.birthdayVisibility
  ...
  return (
    <SettingsSelectionScreen title={t('settings.privacy.birthday')}>

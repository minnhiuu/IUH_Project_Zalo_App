...
export default function AllowCallsScreen() {
  ...
  const selectedScope = privacySettings?.allowCallsPrivacy
  ...
  return (
    <SettingsSelectionScreen title={t('settings.privacy.allowCalls')}>

    ...
    <SettingsDetailScreen title={t('settings.menu.about.title')}>
      ...
      <SettingsCard>
        <View className='px-6 py-5'>
          <Text className='text-base text-gray-700 text-center leading-6'>{t('settings.about.description')}</Text>
        </View>
      </SettingsCard>
      ...
      <SettingsCard>
        <View className='px-4 py-6 items-center'>
          <Text className='text-sm text-gray-400 text-center'>{t('settings.about.copyright')}</Text>
        </View>
      </SettingsCard>

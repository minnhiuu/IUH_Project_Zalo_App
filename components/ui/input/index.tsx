...
const Input = React.forwardRef<View, IInputProps>(function Input(
  { className, style, children, isDisabled, ...props },
  ref
) {
  return (
    <View
...
const InputIcon = React.forwardRef<View, IInputIconProps>(function InputIcon(
  { className, as: AsComponent, style, ...props },
  ref
) {
  if (AsComponent) {
...
const InputSlot = React.forwardRef<View, IInputSlotProps>(function InputSlot({ className, style, ...props }, ref) {
  return (
    <Pressable
      ref={ref as any}
      style={(state) => [

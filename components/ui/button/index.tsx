...
const Button = React.forwardRef<View, IButtonProps>(
  function Button({ className, variant = 'default', size = 'default', style, disabled, isDisabled, children, ...props }, ref) {
...
const ButtonText = React.forwardRef<Text, IButtonTextProps>(
  function ButtonText({ className, style, ...props }, ref) {
    return (
      <Text
        ref={ref}
        style={[{
...
const ButtonSpinner = React.forwardRef<ActivityIndicator, IButtonSpinnerProps>(
  function ButtonSpinner({ className, style, color = '#ffffff', size = 'small', ...props }, ref) {
    return (
      <ActivityIndicator
        ref={ref as any}
        color={color}
...
const ButtonIcon = React.forwardRef<View, IButtonIcon>(
  function ButtonIcon({ className, as: AsComponent, style, height = 16, width = 16, ...props }, ref) {
    if (AsComponent) {
...
const ButtonGroup = React.forwardRef<View, IButtonGroupProps>(
  function ButtonGroup({ className, space = 'md', flexDirection = 'column', isAttached = false, style, ...props }, ref) {
    const getSpaceValue = () => {

        ...
        >
          ...
          <View className="px-4">
            ...
            <View className="mb-4">
              ...
              {errors.fullName && (
                <Text className="text-red-500 text-xs mt-1 ml-4">{errors.fullName}</Text>
              )}
            </View>
            ...
            <View className="mb-4">
              ...
              {errors.phoneNumber && (
                <Text className="text-red-500 text-xs mt-1 ml-4">{errors.phoneNumber}</Text>
              )}
            </View>
            ...
            >
              ...
              <Text className="flex-1 text-gray-600 text-sm ml-3 leading-5">
                ...
                <Text className="text-[#0068FF]">{t('auth.register.termsOfService')}</Text>
                {' '}{t('auth.register.and')}{' '}
                <Text className="text-[#0068FF]">{t('auth.register.privacyPolicy')}</Text>

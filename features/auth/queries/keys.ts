...
export const authKeys = {
  ...
  refresh: (refreshToken?: string) =>
    refreshToken ? ([...authKeys.all(), 'refresh', refreshToken] as const) : ([...authKeys.all(), 'refresh'] as const),

  logout: () => [...authKeys.all(), 'logout'] as const,

  validate: (token?: string) =>
    token ? ([...authKeys.all(), 'validate', token] as const) : ([...authKeys.all(), 'validate'] as const),
